...
public class StudentData {
    ...
    private static void init() {
        ...
        STUDS[6] = new Student("7", "周毅", "男", "复旦大学", "软件工程", "43", "深圳", "13523281231", "555@qq.com");
        STUDS[7] = new Student("8", "萧炎", "男", "武汉大学", "机械工程", "9", "武汉", "13713137631", "123@qq.com");
        STUDS[8] = new Student("9", "萧然", "男", "武汉大学", "土木工程", "22", "北京", "13512381293", "123@qq.com");
        STUDS[9] = new Student("10", "李华", "男", "清华大学", "计算机科学与技术", "31", "长沙", "13712383128", "666@qq.com");
